...
// GitHub OAuth Strategy - Only initialize if GitHub credentials are provided
if (process.env.GITHUB_CLIENT_ID && process.env.GITHUB_CLIENT_SECRET) {
  ...
  console.log('GitHub OAuth disabled: GITHUB_CLIENT_ID and/or GITHUB_CLIENT_SECRET not configured');
}
...
// GitHub OAuth routes - Only add if GitHub OAuth is configured
if (process.env.GITHUB_CLIENT_ID && process.env.GITHUB_CLIENT_SECRET) {
  router.get('/github',
  ...
  // Add placeholder routes that return an error when GitHub OAuth is not configured
